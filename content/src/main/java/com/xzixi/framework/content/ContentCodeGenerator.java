...
public class ContentCodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        config.setMapperPackage("com.xzixi.framework.content.mapper");
        config.setDataPackage("com.xzixi.framework.content.data");
        config.setDataImplPackage("com.xzixi.framework.content.data.impl");
        config.setServicePackage("com.xzixi.framework.content.service");
        config.setServiceImplPackage("com.xzixi.framework.content.service.impl");
        config.setControllerPackage("com.xzixi.framework.content.controller");
