...
import com.xzixi.framework.webapp.constant.JobConstant;
...
import com.xzixi.framework.webapp.model.vo.JobVO;
import com.xzixi.framework.webapp.service.*;
 ...
 */
@Service
public class JobServiceImpl extends BaseServiceImpl<IJobData, com.xzixi.framework.webapp.model.po.Job> implements IJobService {
    ...
    public void saveJob(com.xzixi.framework.webapp.model.po.Job job, Collection<JobParameter> parameters) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public void updateJob(com.xzixi.framework.webapp.model.po.Job job, Collection<JobParameter> parameters) {
        checkParameters(job.getJobTemplateId(), parameters);
    ...
    public void removeJobsByIds(Collection<Integer> ids) {
        Collection<com.xzixi.framework.webapp.model.po.Job> jobs = listByIds(ids);
    ...
    public void pauseByIds(Collection<Integer> ids) {
        Collection<com.xzixi.framework.webapp.model.po.Job> jobs = listByIds(ids);
        for (com.xzixi.framework.webapp.model.po.Job job : jobs) {
            try {
    ...
    @Override
    public JobVO buildVO(com.xzixi.framework.webapp.model.po.Job job, JobVO.BuildOption option) {
    ...
    @Override
    public List<JobVO> buildVO(Collection<com.xzixi.framework.webapp.model.po.Job> jobs, JobVO.BuildOption option) {
        ...
        if (option.isParameters()) {
            List<JobParameter> parameters = jobParameterService.listByJobIds(jobs.stream().map(com.xzixi.framework.webapp.model.po.Job::getId).collect(Collectors.toList()));
    ...
    private void scheduleJob(com.xzixi.framework.webapp.model.po.Job job, Collection<JobParameter> parameters) {
        // 任务模板
     ...
     * @param job 定时任务
     */
    private boolean unscheduleJob(com.xzixi.framework.webapp.model.po.Job job) {
        try {
     ...
     * @param jobs 定时任务集合
     */
    private boolean unscheduleJobs(Collection<com.xzixi.framework.webapp.model.po.Job> jobs) {
    ...
    private TriggerKey buildTriggerKey(com.xzixi.framework.webapp.model.po.Job job) {
        return new TriggerKey(job.getTriggerName(), job.getTriggerGroup());
    }

    private List<TriggerKey> buildTriggerKeys(Collection<com.xzixi.framework.webapp.model.po.Job> jobs) {
