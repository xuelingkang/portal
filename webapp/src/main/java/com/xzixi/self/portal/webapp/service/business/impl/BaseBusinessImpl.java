...
import com.xzixi.self.portal.webapp.service.business.IBaseBusiness;
 ...
 * @author 薛凌康
 */
public class BaseBusinessImpl<T extends BaseModel, D extends IBaseData<T>> implements IBaseBusiness<T, D> {
