...
public class User extends BaseModel {
    ...
    @Null(groups = {UserLogon.class, UserSave.class}, message = "用户id必须为空！")
    private Integer id;

    @ApiModelProperty(value = "用户名")
    @NotBlank(groups = {UserLogon.class, UserSave.class}, message = "用户名不能为空！")
    private String username;

    @ApiModelProperty(value = "密码")
    @NotEmpty(groups = {UserLogon.class, UserSave.class}, message = "密码不能为空！")
    private String password;

    @ApiModelProperty(value = "邮箱")
    @NotBlank(groups = {UserLogon.class, UserSave.class}, message = "邮箱不能为空！")
    @Email(groups = {UserLogon.class, UserSave.class}, message = "邮箱格式不正确！")
    private String email;

    @ApiModelProperty(value = "昵称")
    @NotBlank(groups = {UserLogon.class, UserSave.class}, message = "昵称不能为空！")
    private String nickname;

    @ApiModelProperty(value = "性别", allowableValues = "MALE,FEMALE")
    @NotNull(groups = {UserLogon.class, UserSave.class}, message = "性别不能为空！")
    private Sex sex;

    @ApiModelProperty(value = "生日")
    @NotNull(groups = {UserLogon.class, UserSave.class}, message = "生日不能为空！")
    private Long birth;
